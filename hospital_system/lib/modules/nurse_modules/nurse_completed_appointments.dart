      ...
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          body: state is LoadingGetComplatedAppointments
              ...
              : state is ErrorGetComplatedAppointments
                  ? Center(
                      child: Text(cubit.errorModel!.message!),
                    )
                  : cubit.getComplatedAppointmentsModel == null
                      ? Center(child: loading)
                      : Padding(
                          padding: const EdgeInsets.all(16.0),
                          child: AnimationLimiter(
                            child: cubit.getComplatedAppointmentsModel
                                            ?.result ==
                                        null &&
                                                          ...
                                                          Row(
                                                            children: [
                                                              const Icon(Icons
                                                                  .calendar_month),
                                                              Text(
                                                                  ' ${formatDateWithHours(model.createdAt!)}'),
                                                            ],
                                                          ),
                                                          const SizedBox(
                                                              height: 8),
                                                            ...
                                                            itemBuilder:
                                                              ...
                                                              return Row(
                                                                children: [
                                                                  Expanded(
                                                                    child: Text(
                                                                        medications[startIndex].medication!.name ??
                                                                            ''),
                                                                  ),
                                                                  const SizedBox(
                                                                      width:
                                                                  ...
                                                                  if (endIndex <
                                                                    ...
                                                                    Expanded(
                                                                      child: Text(
                                                                          medications[endIndex].medication!.name ??
                                                                              ''),
                                                                    ),
                                                                ],
                                                              );
                                                                            ...
                                                                            ClipRRect(
                                                                              ...
                                                                              child: MaterialButton(
                                                                                onPressed: () async {
                                                                                  ...
                                                                                  await cubit.checkComplete(token: token!, appointmentId: model.sId!);
                                                                                  // medicineToApi = [];
                                                                                  // selectedMedicines = [];
