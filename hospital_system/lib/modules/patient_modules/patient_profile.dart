...
import 'package:hospital_system/modules/patient_modules/patient_change_password.dart';
...
class PatientProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<PatientCubit, PatientState>(
      bloc: PatientCubit.get(context)..getPatientProfile(token: token!),
      listener: (context, state) {},
      builder: (context, state) {
        internetConection('patient', context);
        PatientCubit cubit = PatientCubit.get(context);
        var model = cubit.getPatientProfileModel?.data;
        return Scaffold(
          appBar: AppBar(
          ...
          body: state is LoadingGetPatientProfile
              ? Center(child: loading)
              : state is ErrorGetPatientProfile
                  ? Center(
                      child: Text(cubit.errorModel!.message!),
                    )
                  : cubit.getPatientProfileModel == null
                      ? Center(
                          child: loading,
                        )
