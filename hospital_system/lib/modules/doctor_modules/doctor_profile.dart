...
import 'package:hospital_system/modules/doctor_modules/doctor_change_password.dart';
...
class DoctorProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<DoctorCubit, DoctorState>(
      bloc: DoctorCubit.get(context)..getDoctorProfile(token: token!),
      listener: (context, state) {},
      builder: (context, state) {
        internetConection('doctor', context);
        DoctorCubit cubit = DoctorCubit.get(context);
        var model = cubit.getDoctorProfileModel?.data;
        return Scaffold(
          appBar: AppBar(
          ...
          body: state is LoadingGetDoctorProfile
              ? Center(child: loading)
              : state is ErrorGetDoctorProfile
                  ? Center(
