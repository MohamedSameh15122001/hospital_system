...
import 'package:hospital_system/modules/manager_modules/manager_search_patient.dart';
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              InkWell(
                onTap: () {
                  navigateToWithFade(context, MangerSearchPatient());
                },
                child: CircleAvatar(
                              ...
                              child: AnimationLimiter(
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    var model = cubit
                                        .getAllPatientsModel!.result![index];
          ...
          floatingActionButton: FloatingActionButton(
            ...
            onPressed: () {
              navigateToWithFade(context, MangerAddPatient());
            },
          ),
        );
      },
