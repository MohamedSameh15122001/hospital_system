      ...
      builder: (context, state) {
        ...
        return Scaffold(
              ...
              : cubit.getAllMedicationsModel!.result!.isEmpty
                  ...
                  : Padding(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: cubit.getAllMedicationsModel!.result!.length,
                        itemBuilder: (context, index) {
                          var model =
                              cubit.getAllMedicationsModel!.result![index];
                          return GestureDetector(
                            onTap: () {
                              navigateTo(context,
                                  MangerUpdateMedication(id: model.sId!));
                            },
                            child: Container(
                              ...
                              child: ListTile(
                                leading: const CircleAvatar(
                                  radius: 30,
                                  backgroundColor: Color(0x9650DEC9),
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('Doses: ${model.doses}'),
                                    const SizedBox(height: 4),
                                    Text('Warnings: ${model.warnings}'),
                                    const SizedBox(height: 4),
                                    Text('Side Effects: ${model.sideEffects}'),
                                    const SizedBox(height: 8),
                                  ],
                                ),
                              ),
          ...
          floatingActionButton: FloatingActionButton(
            ...
            onPressed: () {
              navigateTo(context, MangerAddMedication());
            },
          ),
        );
      },
